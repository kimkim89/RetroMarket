			...
			<div class="container" style="max-width: 830px;">
				...
				<!-- 주소 -->		
					<div class="flex">
						<div class="input-group-icon mt-10" style="width: 60%;">
							...
							<input type="text" id="address1" name="address1" placeholder="우편 번호" required class="single-input">
						<!-- 주소1 체크 -->
				...
				<!-- 주소 -->
					...
					<div class="input-group-icon mt-10" >
							...
							<input type="text" id="address2" name="address2" placeholder="상세 주소" required class="single-input">
						<!-- 주소2 체크 -->
